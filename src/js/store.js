...
(function () {
   ...
   * applied to it (gate 8). Beyond that, still no status or criticality on the row
   * itself — those stay later gates' job; this gate only adds "when is this due," on
   * top of "does this type apply to this project." */
