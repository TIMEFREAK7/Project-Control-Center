(function () {
  ...
  function renderForm(container, rfi, projects, onSaved) {
    ...
    activitySelect.id = "rfifield-activity_id";
    activityOptionsFor(activitySelect, window.PCC.store.get(), projSelect.value, rfi.activity_id);
  ...
  function renderRfiDetails(r, onChanged) {
    ...
    if (r.source_meeting_id) {
      ...
      if (sourceMeeting) {
        ...
        sourceList.style.marginTop = "var(--space-3)";
        sourceList.style.paddingTop = "var(--space-3)";
