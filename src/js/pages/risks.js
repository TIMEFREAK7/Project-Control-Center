(function () {
  ...
  function renderHeatmap(allRisks, rerender) {
    ...
    sub.textContent = "Click a cell to filter the list below by that probability/impact combination.";
    ...
    ["high", "medium", "low"].forEach(function (prob) {
      ...
      ["low", "medium", "high"].forEach(function (impact) {
        var count = allRisks.filter(function (r) {
  ...
  function render(outlet) {
    ...
    outlet.appendChild(renderHeatmap(data.risks, rerender));
