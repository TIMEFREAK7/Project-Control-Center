...
export const ACTION_CENTRE_DELAY_CATEGORY_LABELS = {
...
export function upcomingWindowDays(data) {
...
export function bucketFor(dueDate, windowDays) {
...
export function collectItems(data, activeProjectIds) {
  const items = [];
...
export function buildBuckets(windowDays) {
  return [
